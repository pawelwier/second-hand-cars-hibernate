package pl.akademiakodu.export;
...
public class CreatorXLS<Car> {

    private Class CarClass;

    public CreatorXLS(Class CarClass) {
        this.CarClass = CarClass;
    }

    public void createFile(List<Car> series, String path, String fileName) throws NoSuchMethodException, InvocationTargetException, IllegalAccessException, IOException {
